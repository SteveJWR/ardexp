#!/bin/bash
#SBATCH --job-name JPAL_app              # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH --time 0-3:00                # Wall time limit in D-HH:MM
...
module load R/4.0.0-foss-2020a #most things I have loaded relevant versions here
Rscript R/semisynthetic_example_GATE.R
